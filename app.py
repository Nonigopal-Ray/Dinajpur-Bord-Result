...
st.markdown('<div class="developer-badge">✨ App Developed by: <a style="color:white" href="https://www.facebook.com/nonigopalrays">Nonigopal Ray</a> ✨</div>', unsafe_allow_html=True)
st.write("---")
